package laya.webgl.resource { 
	...
	public class CharRender_Native extends ICharRender{
		...
		public override function getWidth(str:String):Number {
			...
			if (lastFont != CharBook._curFont) {
				window.conchTextCanvas.font	= CharBook._curFont;
				lastFont = CharBook._curFont;
		 ...
		 */
		//TODO:coverage
		public override function getCharBmp( char:String, font:String, lineWidth:int, colStr:String, strokeColStr:String, size:CharRenderInfo, margin_left:int, margin_top:int, margin_right:int, margin_bottom:int):ImageData {
