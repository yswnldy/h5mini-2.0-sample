	...
	public class ShaderInstance extends Resource {
		...
		private function _create():void {
			...
			for (i = 0; i < nUniformNum; i++) {
				...
				var uniform:Array = _uniformMap[uniName];
				if (uniform != null) {
					...
					trace("Shader3D:can't find uinform name:" + _uniformMap[one.name] + " in shader file.");
				}
			}
		...
		//* @private
		//*/
		//public function _attribute(one:*, value:Array):int {
		//var gl:WebGLContext = LayaGL.instance;
		//var bindedAttributeBuffer:Array = Buffer._bindedAtributeBuffer;
		//var bindedAttributeDeclaration:Array = Buffer._bindedAttributeDeclaration;
		//
		//var location:int = one.location;
		//var verBuf:* = Buffer._bindedVertexBuffer as VertexBuffer3D;
