package laya.d3.shader {
	...
	public class ShaderData implements IClone {
		 ...
		 * @private
		 */
		public function ShaderData(ownerResource:Resource, length:int) {
		 ...
		 * @private
		 */
		public function _initData(length:int):void {
		 ...
		 * @private [NATIVE]
		 */
		public function _initDataForNative(length:int):void {
			if (!length)
			{
