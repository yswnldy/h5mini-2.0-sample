package laya.d3.core {
	...
	public class RenderableSprite3D extends Sprite3D {
		...
		/**着色器变量名，光照贴图缩放和偏移。*/
		public static var LIGHTMAPSCALEOFFSET:int;
		/**着色器变量名，光照贴图缩。*/
		public static var LIGHTMAP:int;
		/**拾取颜色。*/
		public static var PICKCOLOR:int;
		...
		/**@private */
		public static var shaderUniforms:ShaderUniforms = new ShaderUniforms(Sprite3D.shaderUniforms);
		...
		public static function __init__():void {
			...
			LIGHTMAPSCALEOFFSET = shaderUniforms.registerUniform();
			LIGHTMAP = shaderUniforms.registerUniform();
			PICKCOLOR = shaderUniforms.registerUniform();
		}
