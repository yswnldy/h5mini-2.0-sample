package laya.d3.core.scene 
{
	...
	public interface ITreeNode 
	{
		...
		function cullingShadowObjects(lightBoundFrustum:Vector.<BoundFrustum>, splitShadowQueues:Vector.<RenderQueue>, testVisible:Boolean, flags:int, scene:Scene3D):void;
		function cullingShadowObjectsOnePSSM(lightBoundFrustum:BoundFrustum,splitShadowQueues:Vector.<RenderQueue>, lightViewProjectMatrix:Matrix4x4,testVisible:Boolean, flags:int, scene:Scene3D):void;
