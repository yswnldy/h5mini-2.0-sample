package laya.d3.core.trail {
	...
	public class TrailRenderElement extends GeometryElement {
		...
		public function TrailRenderElement(owner:TrailFilter) {
			...
			_resizeData(_increaseSegementCount, bufferState);
		}
		...
		private function _resizeData(segementCount:int, bufferState:BufferState):void {
			...
			_vertexBuffer1 = new VertexBuffer3D(vertexCount * vertexDeclaration1.vertexStride, WebGLContext.STATIC_DRAW, false);
			_vertexBuffer1.vertexDeclaration = vertexDeclaration1
			
			_vertices2 = new Float32Array(vertexCount * _floatCountPerVertices2);
			_vertexBuffer2 = new VertexBuffer3D(vertexCount * vertexDeclaration2.vertexStride, WebGLContext.DYNAMIC_DRAW, false);
