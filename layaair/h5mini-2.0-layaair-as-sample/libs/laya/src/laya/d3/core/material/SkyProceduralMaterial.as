package laya.d3.core.material {
	...
	public class SkyProceduralMaterial extends BaseMaterial {
		/** 太阳_高质量*/
		public static const SUN_HIGH_QUALITY:int = 0;
		/** 太阳_精简*/
		public static const SUN_SIMPLE:int = 1;
		/** 太阳_无*/
		public static const SUN_NODE:int = 2;
		
		/**@private */
		public static const SUNSIZE:int = 1;
		/**@private */
		public static const SUNSIZECONVERGENCE:int = 2;
		/**@private */
		public static const ATMOSPHERETHICKNESS:int = 3;
		/**@private */
		public static const SKYTINT:int = 4;
		/**@private */
		public static const GROUNDTINT:int = 5;
		/**@private */
		public static const EXPOSURE:int = 6;
		...
		/**@private */
		private var _sun:int;
		
		/**
		 * 获取太阳状态。
		 * @return  太阳状态。
		 */
		public function get sun():int {
			return _sun;
		}
		 ...
		 * @param value 太阳状态。
		 */
		public function set sun(value:int):void {
			switch (value) {
