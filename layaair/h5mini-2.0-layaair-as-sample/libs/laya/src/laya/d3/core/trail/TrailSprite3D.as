package laya.d3.core.trail {
	...
	public class TrailSprite3D extends RenderableSprite3D {
		...
		public static var LIFETIME:int;
		public static var WIDTHCURVE:int;
		public static var WIDTHCURVEKEYLENGTH:int;
		public static var GRADIENTCOLORKEY:int;
		public static var GRADIENTALPHAKEY:int;
		...
		/**@private */
		public static var shaderUniforms:ShaderUniforms = new ShaderUniforms(RenderableSprite3D.shaderUniforms);
		...
		public static function __init__():void {
			...
			CURTIME = shaderUniforms.registerUniform();
			LIFETIME = shaderUniforms.registerUniform();
			WIDTHCURVE = shaderUniforms.registerUniform();
			WIDTHCURVEKEYLENGTH = shaderUniforms.registerUniform();
			GRADIENTCOLORKEY = shaderUniforms.registerUniform();
			GRADIENTALPHAKEY = shaderUniforms.registerUniform();
		}
