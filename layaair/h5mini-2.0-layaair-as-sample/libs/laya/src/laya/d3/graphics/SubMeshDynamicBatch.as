package laya.d3.graphics {
	...
	public class SubMeshDynamicBatch extends GeometryElement {
		...
		public function SubMeshDynamicBatch() {
			var maxVerDec:VertexDeclaration = VertexPositionNormalColorTexture0Texture1STangent.vertexDeclaration;
		...
		override public function _prepareRender(state:RenderContext3D):Boolean {
			...
			_applyBufferState(MeshRenderDynamicBatchManager.instance._getBufferState(vertexDeclaration));
