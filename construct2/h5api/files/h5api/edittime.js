...
AddCondition(0, cf_none, "can play ad", "广告API", "can play ad", "返回是否还可播放广告", "canPlayAd");

AddCondition(1, cf_trigger, "H5API submit score complete", "积分API", "submit score complete", "积分提交是否成功", "submitScoreComplete");
